...
const ModeratePoints = () => {
    ...
    const handleFileChange1 = (e) => {
        console.log(editedPointImage);
        const files = e.target.files;
        console.log(existingImages);
        // Додаємо вже існуючі картинки як файли для відправки
        const updatedImages = [...editedPointImage]; // Копіюємо існуючі зображення

        existingImages.forEach(async (image) => {
            // Використовуємо проксі для запитів
            ...
            updatedImages.push({
                file, // Додаємо файл до стану
            });

            // Оновлюємо стан після кожного доданого файлу
...
//     }
        ...
        //     reader.onload = (e) => {
        //         updatedImages.push({
        //             filename: file.name, // Додаємо ім'я файлу
        ...
        //     reader.readAsDataURL(file); // Читаємо файл як base64
        // }
    };
